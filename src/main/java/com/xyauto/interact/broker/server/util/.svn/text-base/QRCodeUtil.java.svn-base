...
public class QRCodeUtil {
    ...
    private static void insertImage(BufferedImage source, String logoPath, boolean needCompress) throws Exception {     
    	...
    	if (logoPath.toLowerCase().startsWith("http://")
                || logoPath.toLowerCase().startsWith("https://")) {
...
//        Image src = ImageIO.read(new File(logoPath));  	 
    ...
    public static BufferedImage encodeImage(String content, String logoPath,boolean needCompress) throws Exception {
    	 BufferedImage image = QRCodeUtil.createImage(content, logoPath, needCompress);
        return image;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        //含Logo，指定二维码图片名
        String str=String.format(BrokerEnum.website, 1);
        QRCodeUtil.encode(text, "", "e:\\qrcode", "qrcode", true);
    }
}
